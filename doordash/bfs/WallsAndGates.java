    ...
    public void wallsAndGates(int[][] rooms) {
        ...
        for (int i = 0; i < rows; i++) {
            for (int j = 0; j < cols; j++) {
                if (rooms[i][j] == 0) {
                    //basically traversing through the matrix to find the desired value from where
                    //we want to start our BFS
        ...
        //Perform BFS
        while (!queue.isEmpty()) {
            //remove the element from the queue which is the starting point
            //check the values in all 4 valid directions and check if you find the desired value
